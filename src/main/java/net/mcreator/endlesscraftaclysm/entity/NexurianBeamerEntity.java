...
public class NexurianBeamerEntity extends Monster implements RangedAttackMob {
	public NexurianBeamerEntity(EntityType<NexurianBeamerEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(EndlesscraftaclysmModEntities.NEXURIAN_BEAMER.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> world.getDifficulty() != Difficulty.PEACEFUL

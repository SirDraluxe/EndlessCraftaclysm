...
public class NexurianBattlehogRaiderEntity extends Monster {
	public NexurianBattlehogRaiderEntity(EntityType<NexurianBattlehogRaiderEntity> type, Level world) {
		super(type, world);
		xpReward = 3;
		setNoAi(false);

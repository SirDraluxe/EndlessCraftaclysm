...
public class NexurianGalanthisEntity extends Monster {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new MeleeAttackGoal(this, 1.2, false) {
			...
			protected boolean canPerformAttack(LivingEntity entity) {
				return this.isTimeToAttack() && this.mob.distanceToSqr(entity) < 100 && this.mob.getSensing().hasLineOfSight(entity);
			}
		});
	...
	public void die(DamageSource source) {
		super.die(source);
		NexurianGalanthisEntityDiesProcedure.execute(this.level());
	}

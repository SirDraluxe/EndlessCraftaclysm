...
public class NexurianCallerEntity extends Monster implements RangedAttackMob {
	public NexurianCallerEntity(EntityType<NexurianCallerEntity> type, Level world) {
		super(type, world);
		xpReward = 2;
		setNoAi(false);
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(EndlesscraftaclysmModEntities.NEXURIAN_CALLER.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, (entityType, world, reason, pos, random) -> world.getDifficulty() != Difficulty.PEACEFUL

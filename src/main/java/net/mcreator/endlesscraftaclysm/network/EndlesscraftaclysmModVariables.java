...
public class EndlesscraftaclysmModVariables {
	...
	public static void init(FMLCommonSetupEvent event) {
		EndlesscraftaclysmMod.addNetworkMessage(SavedDataSyncMessage.TYPE, SavedDataSyncMessage.STREAM_CODEC, SavedDataSyncMessage::handleData);
	}
	...
	public static class WorldVariables extends SavedData {
		public static final SavedDataType<WorldVariables> TYPE = new SavedDataType<>(Identifier.parse("endlesscraftaclysm:worldvars"), level -> new WorldVariables(), level -> CompoundTag.CODEC.xmap(tag -> {
	...
	public static class MapVariables extends SavedData {
		public static final SavedDataType<MapVariables> TYPE = new SavedDataType<>(Identifier.parse("endlesscraftaclysm:mapvars"), level -> new MapVariables(), level -> CompoundTag.CODEC.xmap(tag -> {
			MapVariables instance = new MapVariables();
			instance.read(tag, level.registryAccess());
			return instance;
		}, instance -> instance.save(new CompoundTag(), level.registryAccess())));
		boolean _syncDirty = false;
		public double NexurianSeraphCharge = 0;

		public void read(CompoundTag nbt, HolderLookup.Provider lookupProvider) {
			NexurianSeraphCharge = nbt.getDoubleOr("NexurianSeraphCharge", 0);
		}

		public CompoundTag save(CompoundTag nbt, HolderLookup.Provider lookupProvider) {
			nbt.putDouble("NexurianSeraphCharge", NexurianSeraphCharge);
			return nbt;
		}
	...
	public record SavedDataSyncMessage(int dataType, SavedData data) implements CustomPacketPayload {
		public static final Type<SavedDataSyncMessage> TYPE = new Type<>(Identifier.fromNamespaceAndPath(EndlesscraftaclysmMod.MODID, "saved_data_sync"));

...
public class ArmorTheftedMobEffect extends MobEffect {
	public ArmorTheftedMobEffect() {
		...
		this.addAttributeModifier(Attributes.ARMOR, Identifier.fromNamespaceAndPath(EndlesscraftaclysmMod.MODID, "effect.armor_thefted_0"), -1, AttributeModifier.Operation.ADD_VALUE);
	}
}
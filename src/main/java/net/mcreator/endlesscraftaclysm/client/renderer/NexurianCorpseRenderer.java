...
public class NexurianCorpseRenderer extends HumanoidMobRenderer<NexurianCorpseEntity, HumanoidRenderState, HumanoidModel<HumanoidRenderState>> {
	private final Identifier entityTexture = Identifier.parse("endlesscraftaclysm:textures/entities/nexurian_corpse_64_32.png");

	public NexurianCorpseRenderer(EntityRendererProvider.Context context) {
	...
	@Override
	public void extractRenderState(NexurianCorpseEntity entity, HumanoidRenderState state, float partialTicks) {

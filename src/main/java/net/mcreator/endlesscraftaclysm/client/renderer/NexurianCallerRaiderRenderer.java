...
import net.mcreator.endlesscraftaclysm.entity.NexurianCallerRaiderEntity;

import com.mojang.blaze3d.vertex.PoseStack;

public class NexurianCallerRaiderRenderer extends MobRenderer<NexurianCallerRaiderEntity, VillagerRenderState, VillagerModel> {
	private final Identifier entityTexture = Identifier.parse("endlesscraftaclysm:textures/entities/nexurian_caller.png");

	public NexurianCallerRaiderRenderer(EntityRendererProvider.Context context) {
	...
	@Override
	public void extractRenderState(NexurianCallerRaiderEntity entity, VillagerRenderState state, float partialTicks) {

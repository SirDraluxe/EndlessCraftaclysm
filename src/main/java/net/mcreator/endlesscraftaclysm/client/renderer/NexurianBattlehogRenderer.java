...
import net.mcreator.endlesscraftaclysm.entity.NexurianBattlehogEntity;
...
public class NexurianBattlehogRenderer extends MobRenderer<NexurianBattlehogEntity, LivingEntityRenderState, ModelNexurianBattlehog> {
	private final Identifier entityTexture = Identifier.parse("endlesscraftaclysm:textures/entities/nexurian_battlehog.png");

	public NexurianBattlehogRenderer(EntityRendererProvider.Context context) {
	...
	@Override
	public void extractRenderState(NexurianBattlehogEntity entity, LivingEntityRenderState state, float partialTicks) {
